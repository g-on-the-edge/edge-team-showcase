...
export default function EdgeVenturesBucket() {
  ...
  return (
    ...
    >
      {/* Main card container */}
      <div className="relative p-8 rounded-3xl min-h-[450px] flex flex-col items-center justify-center text-center bg-white/5 border border-[#20B2A4]/20 backdrop-blur-xl transition-all duration-500">
        {/* Gradient accent at top */}
        <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#20B2A4] to-[#A8D4B8] rounded-t-3xl opacity-60" />
        ...
        <motion.div
          ...
          className="px-6 py-3 rounded-full bg-[#20B2A4]/10 border border-[#20B2A4]/30"
        >
          <span className="text-[#20B2A4] font-bold text-sm uppercase tracking-wider">
            Coming Soon
          </span>
        </motion.div>
        ...
        >
          Portfolio and investment criteria coming soon
        </motion.p>
